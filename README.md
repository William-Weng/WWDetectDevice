...
- [由裝置編號檢測該裝置的名稱等相關資訊。](https://github.com/devicekit/DeviceKit/blob/master/Source/Device.generated.swift)
...
```bash
dependencies: [
    .package(url: "https://github.com/William-Weng/WWDetectDevice.git", .upToNextMajor(from: "1.4.0"))
]
```
